package com.example.carshop.adapters;
...
import com.example.carshop.activities.ViewAllActivity;
...
public class HomePopularAdapter extends RecyclerView.Adapter<HomePopularAdapter.ViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull HomePopularAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
